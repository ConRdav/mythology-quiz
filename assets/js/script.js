...
// console.log(mortalDifficulty.getAttribute("data-value"))
...
// function startGameMortal(e) {
//     console.log(e.target.getAttribute("data-value"))
//     let newThings = questionsMortal.filter((thing)=>{

//         return thing["difficulty"] == 1
//     })
//     console.log(newThings)
//     mortalRules.classList.add('hide')
//     quizGame.classList.remove('hide')
//     document.getElementById("question-number").innerHTML = questionNumber;
//     questionElement.innerHTML = newThings[questionIndex].question
//     answerA.innerHTML = newThings[questionIndex].answers[0].option
//     answerA.onclick = () => {
//         if(newThings[questionIndex].answers[0].answer === true){
...
//     }
// }
//     answerB.innerHTML = newThings[questionIndex].answers[1].option
//     answerB.onclick = () => {
//         if(newThings[questionIndex].answers[1].answer=== true){
...
//     }
// }
//     answerC.innerHTML = newThings[questionIndex].answers[2].option
//     answerC.onclick = () => {
//         if(newThings[questionIndex].answers[2].answer === true){
...
//     }
// }
//     answerD.innerHTML = newThings[questionIndex].answers[3].option
//     answerD.onclick = () => {
//         if(newThings[questionIndex].answers[3].answer === true){
